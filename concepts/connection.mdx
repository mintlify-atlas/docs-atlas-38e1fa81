...
<Tabs>
  <Tab title="QR Code">
    ...
    <Note>
      You can customize the browser name shown in WhatsApp's "Linked Devices" section using the `browser` option.
    </Note>

    ### Listening for QR Code
    ...
    sock.ev.on('connection.update', (update) => {
        ...
        if (qr) {
            // QR code received, display it to user
