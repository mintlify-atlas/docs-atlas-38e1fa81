...
For production applications, implement a custom store using a database to persist messages, chats, and contacts. See the [Store guide](/concepts/store) for implementation examples using PostgreSQL, MongoDB, or SQLite.
